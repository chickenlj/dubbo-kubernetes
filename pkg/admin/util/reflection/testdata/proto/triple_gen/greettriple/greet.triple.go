...
type GreetService interface {
	Greet(ctx context.Context, req *greet.GreetRequest, opts ...client.CallOption) (*greet.GreetResponse, error)
	...
	GreetServerStream(ctx context.Context, req *greet.GreetServerStreamRequest, opts ...client.CallOption) (GreetService_GreetServerStreamClient, error)
}
...
func (c *GreetServiceImpl) Greet(ctx context.Context, req *greet.GreetRequest, opts ...client.CallOption) (*greet.GreetResponse, error) {
...
func (c *GreetServiceImpl) GreetServerStream(ctx context.Context, req *greet.GreetServerStreamRequest, opts ...client.CallOption) (GreetService_GreetServerStreamClient, error) {
...
func (cli *GreetServiceGreetStreamClient) Send(msg *greet.GreetStreamRequest) error {
	return cli.BidiStreamForClient.Send(msg)
}

func (cli *GreetServiceGreetStreamClient) Recv() (*greet.GreetStreamResponse, error) {
	msg := new(greet.GreetStreamResponse)
...
func (cli *GreetServiceGreetClientStreamClient) Send(msg *greet.GreetClientStreamRequest) error {
	return cli.ClientStreamForClient.Send(msg)
}

func (cli *GreetServiceGreetClientStreamClient) CloseAndRecv() (*greet.GreetClientStreamResponse, error) {
	msg := new(greet.GreetClientStreamResponse)
...
type GreetService_GreetServerStreamClient interface {
	...
	ResponseHeader() http.Header
	ResponseTrailer() http.Header
	Msg() *greet.GreetServerStreamResponse
	Err() error
	Conn() (triple_protocol.StreamingClientConn, error)
	Close() error
}
...
func (cli *GreetServiceGreetServerStreamClient) Msg() *greet.GreetServerStreamResponse {
	msg := cli.ServerStreamForClient.Msg()
	if msg == nil {
		return new(greet.GreetServerStreamResponse)
	}
...
type GreetServiceHandler interface {
	...
	GreetClientStream(context.Context, GreetService_GreetClientStreamServer) (*greet.GreetClientStreamResponse, error)
	GreetServerStream(context.Context, *greet.GreetServerStreamRequest, GreetService_GreetServerStreamServer) error
}
...
func (srv *GreetServiceGreetStreamServer) Send(msg *greet.GreetStreamResponse) error {
	return srv.BidiStream.Send(msg)
}

func (srv GreetServiceGreetStreamServer) Recv() (*greet.GreetStreamRequest, error) {
	msg := new(greet.GreetStreamRequest)
...
type GreetService_GreetClientStreamServer interface {
	...
	Recv() bool
	RequestHeader() http.Header
	Msg() *greet.GreetClientStreamRequest
	Err() error
	Conn() triple_protocol.StreamingHandlerConn
}
...
func (srv *GreetServiceGreetClientStreamServer) Recv() bool {
	msg := new(greet.GreetClientStreamRequest)
	return srv.ClientStream.Receive(msg)
}

func (srv *GreetServiceGreetClientStreamServer) Msg() *greet.GreetClientStreamRequest {
	msgRaw := srv.ClientStream.Msg()
	if msgRaw == nil {
		return new(greet.GreetClientStreamRequest)
	}
	return msgRaw.(*greet.GreetClientStreamRequest)
}
...
func (g *GreetServiceGreetServerStreamServer) Send(msg *greet.GreetServerStreamResponse) error {
...
var GreetService_ServiceInfo = server.ServiceInfo{
	...
	Methods: []server.MethodInfo{
		...
		},
		{
			...
			ReqInitFunc: func() interface{} {
				return new(greet.GreetServerStreamRequest)
			},
			StreamInitFunc: func(baseStream interface{}) interface{} {
				return &GreetServiceGreetServerStreamServer{baseStream.(*triple_protocol.ServerStream)}
			},
			MethodFunc: func(ctx context.Context, args []interface{}, handler interface{}) (interface{}, error) {
				req := args[0].(*greet.GreetServerStreamRequest)
